...
const ScreenEditor: React.FC = () => {
  ...
  const [selectedMediaForAdd, setSelectedMediaForAdd] =
  ...
  const [editItemLoop, setEditItemLoop] = useState<"once" | "loop" | "times">(
    "loop"
  );
  ...
  useEffect(() => {
    ...
    const enabledItems = screen.playlist.filter(
      (item) => item.playbackConfig?.enabled !== false
    );
    ...
    if (!currentItem || currentItem.playbackConfig?.enabled === false) {
      ...
      const newIndex = screen.playlist.findIndex(
        (item) => item.id === firstEnabled.id
      );
  ...
  const handleAddMedia = async (media: MediaItem) => {
    ...
    const updatedScreen = {
      ...screen,
      playlist: [...screen.playlist, newItem],
    };
      ...
      <div className="flex gap-8 overflow-hidden h-full">
                  ...
                  >
                    ...
                    <div className="p-3 space-y-2">
                      ...
                      <div className="flex items-start justify-between gap-2">
                        <h4
                          className={`text-sm font-semibold text-slate-900 line-clamp-2 flex-1 ${
                      ...
                      <div className="flex items-center gap-1 pt-2 border-t border-slate-100">
                        ...
                        <button
                          onClick={(e) => {
                            e.stopPropagation();
                            if (
                              confirm(`Remove "${m.name}" from this playlist?`)
                            ) {
        ...
        <div className="w-[400px] bg-black p-4 rounded-xl flex flex-col">
            ...
            <div className="flex gap-2">
              ...
              <button
                onClick={() => {
                  ...
                  const currentEnabledIndex = enabledItems.findIndex(
                    (item) => item.id === screen.playlist[previewIndex].id
                  );
                  const prevIndex =
          ...
          <div
            ...
            style={{
              aspectRatio:
                screen.aspectRatio === "21:9"
                  ? "21/9"
                  : screen.aspectRatio === "4:3"
                  ? "4/3"
                  : "16/9",
              width: "100%",
              maxHeight: "100%",
                    ...
                    <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/80 to-transparent px-4 py-2">
                      <div className="flex items-center justify-between text-white/80 text-xs">
                        <span className="truncate">
                          {allMedia.find((m) => m.id === currentItem?.mediaId)
                            ?.name || "Unknown"}
                        </span>
                ...
                <button
                  onClick={() => {
                    navigator.clipboard.writeText(
                      `https://tv.menupi.com/${screen.screenCode}`
                    );
                    alert("Link copied!");
                  }}
        ...
        {allMedia.length === 0 ? (
          <div className="text-center py-8 text-slate-400">
            ...
            <p className="text-sm mt-2">
              Upload media from the Media Library first
            </p>
          </div>
        ) : (
      ...
      >
        ...
        >
          {selectedMediaForAdd && (
            <div className="bg-slate-50 rounded-lg p-3 mb-4">
              <p className="text-sm font-medium text-slate-700">
                {selectedMediaForAdd.name}
              </p>
              <p className="text-xs text-slate-500 mt-1">
                {selectedMediaForAdd.type === MediaType.IMAGE
                  ? "Image"
                  : selectedMediaForAdd.type === MediaType.PDF
                  ? "PDF"
                  : "GIF"}
              </p>
            </div>
          ...
          <div>
            ...
            />
            <p className="text-xs text-slate-500 mt-1">
              How long this media will display before moving to the next item
              (1-3600 seconds)
            </p>
          </div>
              ...
              >
                ...
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      setEditItemDuration(parseInt(e.target.value) || 1)
                    }
                    required
                  />
                </div>
                ...
                <div>
                  ...
                  <Select
                    ...
                    onChange={(e) =>
                      setEditItemLoop(
                        e.target.value as "once" | "loop" | "times"
                      )
                    }
                  >
                  ...
                  {editItemLoop === "times" && (
                    <div className="mt-2">
                      ...
                      <Input
                        ...
                        value={editItemTimes}
                        onChange={(e) =>
                          setEditItemTimes(parseInt(e.target.value) || 1)
                        }
                        required
                      />
                    </div>
                ...
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      setEditItemPriority(parseInt(e.target.value) || 5)
                    }
                    required
                  />
                  <p className="text-xs text-slate-500 mt-1">
