...
const Dashboard: React.FC = () => {
  ...
  // Connected TVs state
  const [connectedTVs, setConnectedTVs] = useState<any[]>([]);
  const [tvLoading, setTvLoading] = useState(false);
  const [tvMessage, setTvMessage] = useState("");
  const [reassignScreen, setReassignScreen] = useState<{
    device_id: string;
    screen_id: string;
  } | null>(null);
  ...
  return (
    <div className="space-y-6 md:space-y-8 animate-in fade-in duration-500">
                ...
                <AlertTriangle
                  className={`w-5 h-5 flex-shrink-0 mt-0.5 ${
                    warning.warningType === "ban"
                      ? "text-red-600"
                      : warning.warningType === "suspension"
                      ? "text-orange-600"
                      : "text-yellow-600"
                  }`}
                />
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div className="flex-1">
          ...
          <p className="text-slate-600 mt-1 text-sm md:text-base">
            Here's what's happening with your digital signage.
          </p>
        ...
        <div
          className="flex items-center gap-3 bg-gradient-to-br from-white via-indigo-50/50 to-white p-4 pr-6 rounded-2xl border border-indigo-200/60 shadow-lg hover:shadow-xl transition-all duration-300 cursor-pointer group"
      ...
      <div className="grid grid-cols-2 lg:grid-cols-5 gap-4 md:gap-6">
        {/* Screens Stat */}
        <Card
          className="p-5 md:p-6 flex flex-col justify-between h-36 md:h-40 relative overflow-hidden group cursor-pointer hover:scale-[1.02] transition-all duration-300 bg-gradient-to-br from-indigo-50 via-white to-indigo-50/50 border-indigo-200 hover:border-indigo-400 hover:shadow-xl"
        ...
        >
          ...
          <div className="flex items-center justify-between mb-3">
            <div className="flex items-center gap-2.5 text-indigo-600">
              ...
              <span className="font-semibold text-xs md:text-sm text-slate-600">
                Screens
              </span>
            </div>
        ...
        {/* Playlists Stat */}
        <Card
          className="p-5 md:p-6 flex flex-col justify-between h-36 md:h-40 relative overflow-hidden group cursor-pointer hover:scale-[1.02] transition-all duration-300 bg-gradient-to-br from-emerald-50 via-white to-emerald-50/50 border-emerald-200 hover:border-emerald-400 hover:shadow-xl"
          onClick={() => navigate("/screens")}
        >
          <div className="absolute top-0 right-0 p-4 opacity-5 group-hover:opacity-10 transition-opacity">
          ...
          <div>
            <span className="text-4xl md:text-5xl font-bold text-slate-900">
              {screens.reduce((sum, s) => sum + (s.playlist?.length || 0), 0)}
            </span>
        ...
        {/* Media Stat */}
        <Card
          className="p-5 md:p-6 flex flex-col justify-between h-36 md:h-40 relative overflow-hidden group cursor-pointer hover:scale-[1.02] transition-all duration-300 bg-gradient-to-br from-blue-50 via-white to-blue-50/50 border-blue-200 hover:border-blue-400 hover:shadow-xl"
        ...
        {/* Storage Stat */}
        <Card
          className="p-5 md:p-6 flex flex-col justify-between h-36 md:h-40 relative overflow-hidden group cursor-pointer hover:scale-[1.02] transition-all duration-300 bg-gradient-to-br from-purple-50 via-white to-purple-50/50 border-purple-200 hover:border-purple-400 hover:shadow-xl"
          onClick={() => navigate("/media")}
        >
          <div className="absolute top-0 right-0 p-4 opacity-5 group-hover:opacity-10 transition-opacity">
          ...
          <div>
            <span className={`text-2xl md:text-3xl font-bold ${storageColor}`}>
              {storagePercentage.toFixed(0)}%
            </span>
            <p className="text-xs text-slate-500 mt-1">
              {formatStorage(usedStorage)} /{" "}
              {formatStorage(planConfig.storageMB)}
            </p>
          </div>
        </Card>
        ...
        {/* Schedules Stat */}
        <Card
          className="p-5 md:p-6 flex flex-col justify-between h-36 md:h-40 relative overflow-hidden group cursor-pointer hover:scale-[1.02] transition-all duration-300 bg-gradient-to-br from-amber-50 via-white to-amber-50/50 border-amber-200 hover:border-amber-400 hover:shadow-xl"
          onClick={() => navigate("/screens")}
        >
          <div className="absolute top-0 right-0 p-4 opacity-5 group-hover:opacity-10 transition-opacity">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-500">
                      {formatStorage(storageBreakdown.image)}
                    </p>
                  </div>
                </div>
              ...
              <div className="flex items-center justify-between p-3 rounded-lg bg-purple-50/50 border border-purple-100">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-500">
                      {formatStorage(storageBreakdown.video)}
                    </p>
                  </div>
                </div>
              ...
              <div className="flex items-center justify-between p-3 rounded-lg bg-red-50/50 border border-red-100">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-500">
                      {formatStorage(storageBreakdown.pdf)}
                    </p>
                  </div>
                </div>
              ...
              <div className="flex items-center justify-between p-3 rounded-lg bg-pink-50/50 border border-pink-100">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-500">
                      {formatStorage(storageBreakdown.gif)}
                    </p>
                  </div>
                </div>
              ...
              <div className="h-full flex">
                {storageBreakdown.image > 0 && (
                  <div
                    ...
                    style={{
                      width: `${Math.max(
                        (storageBreakdown.image / planConfig.storageMB) * 100,
                        1
                      )}%`,
                    }}
                ...
                {storageBreakdown.video > 0 && (
                  <div
                    ...
                    style={{
                      width: `${Math.max(
                        (storageBreakdown.video / planConfig.storageMB) * 100,
                        1
                      )}%`,
                    }}
                ...
                {storageBreakdown.pdf > 0 && (
                  <div
                    ...
                    style={{
                      width: `${Math.max(
                        (storageBreakdown.pdf / planConfig.storageMB) * 100,
                        1
                      )}%`,
                    }}
                ...
                {storageBreakdown.gif > 0 && (
                  <div
                    ...
                    style={{
                      width: `${Math.max(
                        (storageBreakdown.gif / planConfig.storageMB) * 100,
                        1
                      )}%`,
                    }}
            ...
            <div className="flex flex-wrap gap-4 text-xs">
              <div className="flex items-center gap-2">
                ...
                <span className="text-slate-600">
                  Images: {formatStorage(storageBreakdown.image)}
                </span>
              </div>
              <div className="flex items-center gap-2">
                <div className="w-3 h-3 rounded-full bg-purple-500"></div>
                <span className="text-slate-600">
                  Videos: {formatStorage(storageBreakdown.video)}
                </span>
              </div>
              <div className="flex items-center gap-2">
                <div className="w-3 h-3 rounded-full bg-red-500"></div>
                <span className="text-slate-600">
                  PDFs: {formatStorage(storageBreakdown.pdf)}
                </span>
              </div>
            </div>
          </Card>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        {screens.length > 0 &&
          (() => {
            ...
            const firstMedia = lastScreen.playlist[0]
              ? allMedia.find((m) => m.id === lastScreen.playlist[0].mediaId)
              : null;

            return (
              <div className="lg:col-span-2">
                <Card
                  className="p-0 bg-white border border-slate-200 overflow-hidden hover:shadow-xl transition-all duration-300 group cursor-pointer"
                  onClick={() => navigate(`/screens/${lastScreen.id}`)}
                >
                        ...
                        <div className="flex items-center gap-1.5 text-slate-600">
                          <div
                            className={`w-2 h-2 rounded-full ${
                              lastScreen.lastPing &&
                              Date.now() - lastScreen.lastPing < 60000
            ...
            {isInsightsExpanded && (
              <div className="space-y-3">
                  ...
                  <div className="flex items-start gap-2 p-3 rounded-lg bg-amber-50 border border-amber-200">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-amber-700 mt-0.5">
                        Using {storagePercentage.toFixed(0)}% of storage
                      </p>
                    </div>
                  </div>
                )}
                ...
                {user.plan === PlanType.FREE &&
                  screens.length >= planConfig.maxScreens && (
                    <div className="flex items-start gap-2 p-3 rounded-lg bg-amber-50 border border-amber-200">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              >
                ...
                <div className="relative flex-1">
                  ...
                  <p className="text-sm text-slate-500 mt-0.5">
                    Add images, videos, or PDFs to your library
                  </p>
                </div>
              ...
              >
                ...
                <div className="relative flex-1">
                  ...
                  <p className="text-sm text-slate-500 mt-0.5">
                    Setup a new display for your content
                  </p>
                </div>
            ...
            <Card className="p-6 bg-white border border-slate-200">
              ...
              <div className="space-y-3">
                {recentMedia.map((item) => {
                  const getIcon = () => {
                    if (item.type === MediaType.VIDEO || item.type === "video")
                      return <FileVideo className="w-4 h-4 text-purple-600" />;
                    if (item.type === MediaType.PDF || item.type === "pdf")
      ...
      <Card className="p-6">
        <h3 className="text-xl font-bold mb-4 flex items-center gap-2">
          <Monitor className="w-5 h-5" /> Connected TVs
        </h3>
        {tvLoading ? (
          <div className="text-center text-gray-500">Loading...</div>
        ) : connectedTVs.length === 0 ? (
          <div className="text-center text-gray-500">
            No TVs connected to your account.
          </div>
        ) : (
          <div className="overflow-x-auto">
            <table className="min-w-full text-sm">
              ...
              <tbody>
                {connectedTVs.map((tv) => (
                  <tr key={tv.device_id} className="border-b">
                    <td className="p-2 font-mono text-xs">{tv.device_id}</td>
                    <td className="p-2">{tv.device_name || "-"}</td>
                    <td className="p-2">
                      {tv.screen_name || (
                      ...
                      <select
                        ...
                        value={tv.screen_id || ""}
                        onChange={(e) =>
                          handleReassign(tv.device_id, e.target.value)
                        }
                      >
                    ...
                    <td className="p-2">
                      {tv.last_active
                        ? formatTimeAgo(new Date(tv.last_active).getTime())
                        : "-"}
                    </td>
                    <td className="p-2">
                      <button
                        className="text-red-600 hover:underline"
                        onClick={() => handleDisconnect(tv.device_id)}
                      >
                        Disconnect
                      </button>
                    </td>
